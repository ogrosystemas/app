    ...
    <section class="pb-4">
      ...
      ${criticos.length ? `
        <div style="background:rgba(239,68,68,.08);border:1px solid rgba(239,68,68,.25);border-radius:var(--radius-md);padding:14px 16px;margin-bottom:12px;display:flex;align-items:center;gap:12px">
          <i data-lucide="alert-triangle" style="width:18px;height:18px;color:#f87171;flex-shrink:0"></i>
      ...
      ${prazoProximo.length ? `
        <div style="background:rgba(249,115,22,.08);border:1px solid rgba(249,115,22,.25);border-radius:var(--radius-md);padding:14px 16px;margin-bottom:12px;display:flex;align-items:center;gap:12px">
          <i data-lucide="clock" style="width:18px;height:18px;color:#fb923c;flex-shrink:0"></i>
          <div style="flex:1;min-width:0">
      ...
      <div class="grid-2" style="gap:12px;margin-bottom:12px">
        <div class="kpi-card">
          <div class="kpi-card__label"><i data-lucide="hammer" style="width:13px;height:13px;vertical-align:-2px;margin-right:4px"></i>Produção ativa</div>
          <div class="kpi-card__value" style="color:var(--accent)">${producaoAtiva}</div>
          <div class="kpi-card__sub">${producao.length} total</div>
        </div>
        <div class="kpi-card">
          <div class="kpi-card__label"><i data-lucide="shopping-bag" style="width:13px;height:13px;vertical-align:-2px;margin-right:4px"></i>Pedidos abertos</div>
      ...
      <div class="kpi-card" style="margin-bottom:20px">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
          <div class="kpi-card__label" style="margin-bottom:0">
            <i data-lucide="trending-up" style="width:13px;height:13px;vertical-align:-2px;margin-right:4px"></i>
      ...
      <div class="card" style="margin-bottom:16px">
        ...
        ${producaoRecente.length ? producaoRecente.map(item => `
          <div class="list-item">
            <div class="icon-box icon-box-orange"><i data-lucide="flame"></i></div>
      ...
      <div class="card">
        ...
        ${pedidosRecentes.length ? pedidosRecentes.map(item => `
          <div class="list-item">
            <div class="icon-box icon-box-purple"><i data-lucide="shopping-bag"></i></div>
            <div class="list-item__info">
