 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Se{constructor(e,t,n,s,i,o,u){this.key=e,this.documentType=t,this.version=n,this.readTime=s,this.createTime=i,this.data=o,this.documentState=u}static newInvalidDocument(e){return new Se(e,0,K.min(),K.min(),K.min(),ze.empty(),0)}static newFoundDocument(e,t,n,s){return new Se(e,1,t,K.min(),n,s,0)}static newNoDocument(e,t){return new Se(e,2,t,K.min(),K.min(),ze.empty(),0)}static newUnknownDocument(e,t){return new Se(e,3,t,K.min(),K.min(),ze.empty(),2)}convertToFoundDocument(e,t){return!this.createTime.isEqual(K.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=e),this.version=e,this.documentType=1,this.data=t,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=ze.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=ze.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=K.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof Se&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new Se(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sr{constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}withConverter(e){return new sr(this.firestore,e,this._query)}}class be{constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Gn(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new be(this.firestore,e,this._key)}toJSON(){return{type:be._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(e,t,n){if(po(t,be._jsonSchema))return new be(e,n||null,new $(ae.fromString(t.referencePath)))}}be._jsonSchemaVersion="firestore/documentReference/1.0",be._jsonSchema={type:Me("string",be._jsonSchemaVersion),referencePath:Me("string")};class Gn extends sr{constructor(e,t,n){super(e,t,yo(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new be(this.firestore,null,new $(e))}withConverter(e){return new Gn(this.firestore,e,this._path)}}function nw(r,e,...t){if(r=Re(r),Y2("collection","path",e),r instanceof F1){const n=ae.fromString(e,...t);return Cd(n),new Gn(r,null,n)}{if(!(r instanceof be||r instanceof Gn))throw new F(D.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=r._path.child(ae.fromString(e,...t));return Cd(n),new Gn(r.firestore,null,n)}}function H3(r,e,...t){if(r=Re(r),arguments.length===1&&(e=g1.newId()),Y2("doc","path",e),r instanceof F1){const n=ae.fromString(e,...t);return bd(n),new be(r,null,new $(n))}{if(!(r instanceof be||r instanceof Gn))throw new F(D.INVALID_ARGUMENT,"Expected first argument to doc() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=r._path.child(ae.fromString(e,...t));return bd(n),new be(r.firestore,r instanceof Gn?r.converter:null,new $(n))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rw(){return new Io("deleteField")}function Z3(r){return new ft(r)}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $p{constructor(){this.changes=new En(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Se.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const n=this.changes.get(t);return n!==void 0?P.resolve(n):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Su extends g0{constructor(e){super(),this.firestore=e}convertBytes(e){return new Et(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new be(this.firestore,null,t)}}const $f="@firebase/firestore",Gf="4.16.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class h_{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=$s(e)}set(e,t,n){this._verifyNotCommitted();const s=Un(e,this._firestore),i=bu(s.converter,t,n),o=fu(this._dataReader,"WriteBatch.set",s._key,i,s.converter!==null,n);return this._mutations.push(o.toMutation(s._key,Pe.none())),this}update(e,t,n,...s){this._verifyNotCommitted();const i=Un(e,this._firestore);let o;return o=typeof(t=Re(t))=="string"||t instanceof qs?q1(this._dataReader,"WriteBatch.update",i._key,t,n,s):B1(this._dataReader,"WriteBatch.update",i._key,t),this._mutations.push(o.toMutation(i._key,Pe.exists(!0))),this}delete(e){this._verifyNotCommitted();const t=Un(e,this._firestore);return this._mutations=this._mutations.concat(new Fs(t._key,Pe.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new F(D.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function Un(r,e){if((r=Re(r)).firestore!==e)throw new F(D.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dw(r){r=ct(r,be);const e=ct(r.firestore,Mt),t=Ws(e);return J5(t,r._key).then(n=>E0(e,r,n))}function fw(r){r=ct(r,sr);const e=ct(r.firestore,Mt),t=Ws(e),n=new Su(e);return m0(r._query),Z5(t,r._query).then(s=>new br(e,n,r,s))}function pw(r,e,t){r=ct(r,be);const n=ct(r.firestore,Mt),s=bu(r.converter,e,t),i=$s(n);return Po(n,[fu(i,"setDoc",r._key,s,r.converter!==null,t).toMutation(r._key,Pe.none())])}function gw(r,e,t,...n){r=ct(r,be);const s=ct(r.firestore,Mt),i=$s(s);let o;return o=typeof(e=Re(e))=="string"||e instanceof qs?q1(i,"updateDoc",r._key,e,t,n):B1(i,"updateDoc",r._key,e),Po(s,[o.toMutation(r._key,Pe.exists(!0))])}function mw(r){return Po(ct(r.firestore,Mt),[new Fs(r._key,Pe.none())])}function _w(r,e){const t=ct(r.firestore,Mt),n=H3(r),s=bu(r.converter,e),i=$s(r.firestore);return Po(t,[fu(i,"addDoc",n._key,s,r.converter!==null,{}).toMutation(n._key,Pe.exists(!1))]).then(()=>n)}function yw(r,...e){var l,d,g;r=Re(r);let t={includeMetadataChanges:!1,source:"default"},n=0;typeof e[n]!="object"||jf(e[n])||(t=e[n++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(jf(e[n])){const y=e[n];e[n]=(l=y.next)==null?void 0:l.bind(y),e[n+1]=(d=y.error)==null?void 0:d.bind(y),e[n+2]=(g=y.complete)==null?void 0:g.bind(y)}let i,o,u;if(r instanceof be)o=ct(r.firestore,Mt),u=yo(r._key.path),i={next:y=>{e[n]&&e[n](E0(o,r,y))},error:e[n+1],complete:e[n+2]};else{const y=ct(r,sr);o=ct(y.firestore,Mt),u=y._query;const R=new Su(o);i={next:C=>{e[n]&&e[n](new br(o,R,y,C))},error:e[n+1],complete:e[n+2]},m0(r._query)}const c=Ws(o);return X5(c,u,s,i)}function Po(r,e){const t=Ws(r);return e_(t,e)}function E0(r,e,t){const n=t.docs.get(e._key),s=new Su(r);return new zn(r,s,e._key,n,new is(t.hasPendingWrites,t.fromCache),e.converter)}function Ew(r){return r=ct(r,Mt),Ws(r),new h_(r,e=>Po(r,e))}(function(e,t=!0){Wm(ks),Yt(new kt("firestore",(n,{instanceIdentifier:s,options:i})=>{const o=n.getProvider("app").getImmediate(),u=new Mt(new Xm(n.getProvider("auth-internal")),new e4(o,n.getProvider("app-check-internal")),B4(o,s),o);return i={useFetchStreams:t,...i},u._setSettings(i),u},"PUBLIC").setMultipleInstances(!0)),Rt($f,Gf,e),Rt($f,Gf,"esm2020")})();var p_="firebase",g_="12.15.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ZI(r,e){if(!navigator)throw pe.create("only-available-in-window");return r.onMessageHandler=e,()=>{r.onMessageHandler=null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vw(r=F2()){return XI().then(e=>{if(!e)throw pe.create("unsupported-browser")},e=>{throw pe.create("indexed-db-unsupported")}),Os(Re(r),"messaging").getImmediate()}async function Rw(r,e){return r=Re(r),P7(r,e)}function Sw(r){return r=Re(r),JI(r)}function Pw(r,e){return r=Re(r),ZI(r,e)}YI();export{uw as A,rw as B,kn as G,iw as a,lw as b,nw as c,H3 as d,mw as e,fw as f,Aw as g,_w as h,Pm as i,XI as j,vw as k,Pw as l,Rw as m,Sw as n,yw as o,cw as p,ow as q,hw as r,pw as s,dw as t,gw as u,Iw as v,aw as w,ww as x,Tw as y,Ew as z};
