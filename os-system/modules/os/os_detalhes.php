...
<div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                ...
                <a href="../laudo/form_laudo.php?os_id=<?php echo $id; ?>" class="btn ms-2 no-print" style="background:rgba(99,102,241,.15);border:1px solid rgba(99,102,241,.35);color:#818cf8">
