                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="../laudo/form_laudo.php?os_id=<?php echo $os['id']; ?>" class="btn btn-sm" style="background:rgba(99,102,241,.15);border:1px solid rgba(99,102,241,.3);color:#818cf8" title="Relatório Técnico"><i class="ph-bold ph-clipboard-text"></i></a>
                                    <?php endif; ?>
                                 </tr>
                            </tr>
                            <?php endforeach; ?>
