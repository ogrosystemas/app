        ...
        <tr>
          ...
          <td style="text-align:center">
            <div style="display:flex;gap:5px;justify-content:center">
              ...
              <a href="#" class="btn-os" style="padding:5px 8px;background:rgba(239,68,68,.1);border:1px solid rgba(239,68,68,.2);color:#ef4444" onclick="confirmarDesativar(event,<?= $s['id'] ?>)"><i class="ph-bold ph-trash"></i></a>
            </div>
          </td>
        </tr>
        <?php endforeach; ?>
...
function confirmarDesativar(e, id) {
    e.preventDefault();
    Swal.fire({
        title: 'Desativar serviço?',
        text: 'O serviço será desativado e não aparecerá nas OS.',
        icon: 'warning',
        ...
        if (r.isConfirmed) window.location.href = '?excluir=' + id;
    });
}
</script>
